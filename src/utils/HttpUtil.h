...
bool HttpPost(const char* server, int port, const char* url, StrBuilder* headers, StrBuilder* data, HttpRsp* rspOut);
bool HttpPost(const char* url, StrBuilder* headers, StrBuilder* data, HttpRsp* rspOut);
